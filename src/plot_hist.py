...
def plot_hist(val_list, marker):
    ...
    # Save counts to CSV
    df = pd.DataFrame({
        "Bin": ["{0}", "(0,10]", "(10,100]", "(100,∞)", "Mean", "Median"],
        "Count": [count_0, count_0_10, count_10_100, count_100_inf, mean_val, median_val]
    })

    csv_fn = f'neighbor_hist_filter_{marker}_counts.csv'
    df.to_csv(csv_fn, index=False)

    print(f"{count_0} {count_0_10} {count_10_100} {count_100_inf} {mean_val} {median_val}")
